...
const Header = () => {
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Github
      ...
      <nav class="text-black border-gray-200">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
          <a href="#" class="flex items-center">
            ...
            <span class="self-center text-2xl ml-3 font-extrabold whitespace-nowrap dark:text-black">
            Charity
            </span>
          </a>
          ...
          <div class="flex items-center">
            ...
            >
              <AiFillGithub size={30} color="black" className="mr-5" />{" "}
              {/* Use the GitHub icon */}
            </a>
          </div>
        </div>
